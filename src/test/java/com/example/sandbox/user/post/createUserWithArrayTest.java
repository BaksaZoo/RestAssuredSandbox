...
public class createUserWithArrayTest extends Common {
    ...
    public void testCreateUserWithArray() {
        ...
        // create - 200
        Response response200 = postUrl(createWithArray, createJsonBody(users));
        Assertions.assertReturnCode(response200, 200);

        // create - 405
        Response response405 = postUrl(createWithArray, createJsonBody(emptyBody));
